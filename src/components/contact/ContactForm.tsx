    ...
    <section ref={ref} className="py-16 bg-white dark:bg-black">
      <div className="container-section">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <h2 className="text-3xl font-semibold text-black dark:text-white mb-6">Informações de Contato</h2>
            
            <div className="space-y-8 mb-12">
              <div>
                <h3 className="text-lg font-medium text-black dark:text-white mb-2">Endereço</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-black dark:text-white mb-2">Telefone</h3>
                <p className="text-gray-700 dark:text-gray-300">
                  +55 (11) 3456-7890<br />
                  +55 (11) 98765-4321
                </p>
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  contato@galharufa.com.br<br />
                  casting@galharufa.com.br
                </p>
              </div>
              
              <div>
                <h3 className="text-lg font-medium text-black dark:text-white mb-2">Horário de Atendimento</h3>
                <p className="text-gray-700 dark:text-gray-300">
            ...
            <div>
              <h3 className="text-lg font-medium text-black dark:text-white mb-4">Siga-nos</h3>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl font-semibold text-black dark:text-white mb-6">Envie uma Mensagem</h2>
            
            {submitted ? (
              <div className="bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg p-6 mb-6">
                <h3 className="text-green-800 dark:text-green-200 text-lg font-medium mb-2">Mensagem enviada com sucesso!</h3>
