...
const ContactInfo = () => {
  ...
  const contactItems = [
    ...
    },
    {
      ...
      details: ['Segunda a Sexta: 10h às 19h'],
    },
  ];
    ...
    <section ref={ref} className="py-24 bg-white dark:bg-black">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
        <div className="text-center mb-16">
          ...
          >
            Estamos à disposição para atender suas necessidades. Entre em contato através
        ...
        <div className="bg-gray-50 dark:bg-gray-900 p-8 rounded-xl shadow-md">
          ...
          >
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Prefere uma resposta rápida? Entre em contato diretamente pelo WhatsApp ou
          ...
          >
            <p className="mb-4 text-center">
              Estamos muito felizes com seu interesse em integrar nosso casting, para que
              possamos lhe conhecer melhor, por gentileza, encaminhar para análise seu
              material contendo:
            </p>
