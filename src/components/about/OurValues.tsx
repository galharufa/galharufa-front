...
import { FaStar, FaHandshake, FaLightbulb, FaUsers, FaGlobe, FaHeart } from 'react-icons/fa';

const values = [
  {
    icon: <FaStar className="text-4xl mb-4" />,
    title: 'Excelência',
    description: 'Buscamos a excelência em tudo o que fazemos, desde a seleção de talentos até a execução de projetos.',
  },
  {
    icon: <FaHandshake className="text-4xl mb-4" />,
    title: 'Integridade',
    description: 'Agimos com transparência e ética em todos os relacionamentos, construindo confiança com clientes e talentos.',
  },
  {
    icon: <FaLightbulb className="text-4xl mb-4" />,
    title: 'Inovação',
    description: 'Estamos sempre em busca de novas ideias e abordagens para impulsionar a carreira de nossos talentos.',
  },
  {
    icon: <FaUsers className="text-4xl mb-4" />,
    title: 'Colaboração',
    description: 'Acreditamos no poder do trabalho em equipe e na colaboração para alcançar resultados extraordinários.',
  },
  {
    icon: <FaGlobe className="text-4xl mb-4" />,
    title: 'Diversidade',
    description: 'Valorizamos a diversidade em todas as suas formas, promovendo um ambiente inclusivo e representativo.',
  },
  {
    icon: <FaHeart className="text-4xl mb-4" />,
    title: 'Paixão',
    description: 'Somos movidos pela paixão pelo mundo artístico e pelo desenvolvimento de talentos excepcionais.',
  },
];
