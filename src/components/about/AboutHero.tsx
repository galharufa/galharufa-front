...
const AboutHero = () => {
  ...
  useEffect(() => {
    if (heroRef.current && textRef.current) {
      ...
      tl.from(textRef.current.querySelectorAll('.gsap-about-text'), {
        y: 50,
        opacity: 0,
        stagger: 0.2,
        duration: 1,
  ...
  return (
    ...
    >
      ...
      >
        <motion.h1 
          className="gsap-about-text text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight"
        ...
        <motion.p 
          className="gsap-about-text text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-gray-300"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
