...
const services = [
  {
    ...
    details: [
      'Representação exclusiva para atores, modelos e influenciadores',
      'Negociação de contratos e cachês',
      'Planejamento estratégico de carreira',
      'Assessoria jurídica especializada',
      'Acompanhamento em testes e gravações',
    ],
  ...
  },
  {
    ...
    details: [
      'Produção de books profissionais',
      'Ensaios temáticos para portfólio',
      'Fotos para composites e material promocional',
      'Edição e tratamento de imagens',
      'Direção de arte para ensaios conceituais',
    ],
  ...
  },
  {
    ...
    details: [
      'Seleção de elenco para filmes, séries e novelas',
      'Casting para comerciais e campanhas publicitárias',
          ...
          {services.map((service, index) => (
            ...
            >
              <div className={`${index % 2 !== 0 ? 'lg:order-2' : ''}`}>
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-6 text-center lg:text-left">
                  {service.description}
                </p>
