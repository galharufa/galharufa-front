...
export default function NovoCasting() {
  ...
  const handleSubmit = async (values: typeof form.values) => {
    try {
      ...
      // Criar o casting
      const casting = await CastingService.criarCasting(formData);
      ...
      successToast('Casting criado com sucesso');
      router.push('/admin/casting');
    } catch (error) {
      console.error('Erro ao criar casting:', error);
      errorToast('Erro ao criar casting');
    } finally {
      setIsLoading(false);
    }
  };
