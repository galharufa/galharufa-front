...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Representamos uma ampla variedade de talentos, incluindo atores, atrizes, modelos, influenciadores, apresentadores, e talentos infantis. Nossa agência também trabalha com perfis plus-size e da terceira idade, garantindo diversidade para todos os tipos de projetos.',
    category: 'casting',
  },
  {
    question: 'Quanto tempo leva para receber os perfis após a solicitação?',
    answer:
      'Normalmente, enviamos uma seleção inicial de perfis em até 48 horas após a solicitação formal. Para projetos urgentes, podemos acelerar esse processo e fornecer opções em 24 horas, dependendo da complexidade e especificidade do casting solicitado.',
    category: 'prazos',
  },
  {
    question: 'Vocês trabalham com projetos internacionais?',
    answer:
      'Sim, temos experiência em projetos internacionais e parcerias com agências em diversos países. Podemos facilitar a contratação de talentos brasileiros para produções estrangeiras, bem como auxiliar em questões de visto, logística e requisitos legais para trabalhos internacionais.',
    category: 'projetos',
  },
  {
    question: 'Como são definidos os valores para contratação de talentos?',
    answer:
      'Os valores são definidos com base em diversos fatores, incluindo o tipo de mídia (TV, cinema, internet), abrangência (local, nacional, internacional), tempo de veiculação, exclusividade e a experiência do talento. Trabalhamos com tabelas de referência do mercado e podemos fornecer orçamentos detalhados para cada projeto.',
    category: 'valores',
  },
  {
    question: 'Vocês oferecem serviços de produção além do casting?',
    answer:
      'Sim, além do casting, oferecemos serviços complementares como produção de figurino, maquiagem, locação de espaços para testes e gravações, transporte de talentos e coordenação de elenco durante as produções. Nosso objetivo é facilitar todo o processo para nossos clientes.',
    category: 'servicos',
  },
  {
    question: 'Como faço para me cadastrar como talento na agência?',
    answer:
      'Para se cadastrar como talento, você pode preencher o formulário em nossa página de contato, especificando seu interesse em fazer parte do nosso casting. Solicitamos fotos recentes (rosto e corpo inteiro), informações básicas como idade, altura e experiência prévia. Após análise, nossa equipe entrará em contato caso seu perfil se adeque ao nosso banco de talentos.',
    category: 'cadastro',
  },
  {
    question: 'Quais são os prazos médios para um projeto completo?',
    answer:
      'Os prazos variam conforme a complexidade do projeto. Em média, um processo completo de casting, desde a solicitação até a finalização da contratação, leva de 1 a 3 semanas. Para campanhas maiores ou projetos audiovisuais mais complexos, recomendamos iniciar o processo com pelo menos um mês de antecedência.',
    category: 'prazos',
  },
];
    ...
    <div className="bg-white dark:bg-black min-h-screen">
      ...
      <AnimatedSection className="bg-gray-100 dark:bg-gray-900 py-16" direction="up">
        <div className="container-section text-center">
          <h2 className="heading-secondary text-black dark:text-white mb-4">
            Não encontrou o que procurava?
          </h2>
          <p className="text-gray-700 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Entre em contato conosco diretamente e nossa equipe terá prazer em responder a
            todas as suas perguntas sobre nossos serviços.
          </p>
