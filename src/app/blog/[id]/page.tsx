        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <AnimatedSection className="lg:col-span-2" direction="left" delay={0.4}>
            ...
            <div className="min-h-[400px]">
              ...
              {activeTab === 'experiencia' &&
                blog.experience &&
                blog.experience.length > 0 && (
                  <AnimatedSection direction="up" delay={0.2}>
                    <h2 className="heading-tertiary text-black dark:text-white">
                      Experiência Profissional
                    </h2>
                    <ul className="space-y-4 mt-4">
                      {blog.experience.map((exp: string, index: number) => (
                        <li
                          key={index}
              ...
              {/* Galeria */}
              {activeTab === 'galeria' && blog.gallery && blog.gallery.length > 0 && (
                <AnimatedSection direction="up" delay={0.2}>
                  <h2 className="heading-tertiary text-black dark:text-white">
                    Galeria de Fotos
                  </h2>
